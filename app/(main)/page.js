...
export default function Home() {
  ...
  const categories = [
    { name: "الكترونيات", icon: "/icons/globe.svg" },
    { name: "أثاث منزلي", icon: "/icons/globe.svg" },
    { name: "ملابس", icon: "/icons/globe.svg" },
    { name: "أجهزة رياضية", icon: "/icons/globe.svg" },
    { name: "كتب", icon: "/icons/globe.svg" },
    { name: "ألعاب", icon: "/icons/globe.svg" },
    { name: "مستحضرات تجميل", icon: "/icons/globe.svg" },
    { name: "أدوات مطبخ", icon: "/icons/globe.svg" },
    { name: "إكسسوارات", icon: "/icons/globe.svg" },
    { name: "حقائب", icon: "/icons/globe.svg" },
    { name: "أحذية", icon: "/icons/globe.svg" },
    { name: "ساعات", icon: "/icons/globe.svg" },
  ];
